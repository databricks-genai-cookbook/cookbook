...
# MAGIC %pip install -U -qqqq databricks-agents mlflow mlflow-skinny databricks-vectorsearch langchain==0.2.0 langchain_core==0.2.0 langchain_community==0.2.0 flashrank==0.2.4
