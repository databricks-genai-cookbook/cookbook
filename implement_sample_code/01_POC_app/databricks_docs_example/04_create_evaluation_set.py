...
# MAGIC
# MAGIC Visit [documentation](https://docs.databricks.com/generative-ai/agent-evaluation/evaluation-set.html#evaluation-set-schema) to understand the Quality Lab Evaluation Set schema - these fields are referenced below.
# MAGIC
